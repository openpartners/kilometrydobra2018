    ...
    <div class="container">
      <div class="row">
        <div class="twelve columns">
            <div class="goal">
              <h1><?php the_title(); ?></h1>
              <p>Cel zbiórki:</p>
              <p><?php echo get_post_meta($post->ID, '_org_target', true); ?></p>
            </div>
            <div class="logo" style="background: url('<?= wp_get_attachment_image_src(get_post_meta($post->ID, '_org_logo', true), 'normal')[0] ?>') no-repeat center top; background-size: contain;">
            </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="twelve columns center">
          ...
          <?php if (get_post_meta($post->ID, '_sid', true) || get_post_meta($post->ID, '_paypal_email', true)): ?>
          <a href="<?php bloginfo('wpurl');?>/wplac/?id=<?php echo $post->ID; ?>" id="payButtonBig" style="display:none;"><img src="<?php bloginfo('template_url'); ?>/images/pay.png"></a><br>
          <?php else: ?>
          <a id="payButtonBig"><img src="<?php bloginfo('template_url'); ?>/images/pay.png" style="display:none;"></a>
          <?php endif; ?>
        </div>
      </div>
    </div>
   ...
   <div id="cta">
    ...
    <div class="container">
      <div class="twelve columns">
        ...
        <?php if (get_post_meta($post->ID, '_sid', true) || get_post_meta($post->ID, '_paypal_email', true)): ?>
        <a href="<?php bloginfo('wpurl');?>/wplac/?id=<?php echo $post->ID; ?>" style="display:none;"><img src="<?php bloginfo('template_url'); ?>/images/cta.png"></a>
        <?php else: ?>
        <a class="payment-block" style="display:none;"><img src="<?php bloginfo('template_url'); ?>/images/cta.png"></a>
        <?php endif; ?>
